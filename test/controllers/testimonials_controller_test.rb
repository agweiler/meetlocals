...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { body: @testimonial.body, booking_id: @testimonial.booking_id, title: @testimonial.title }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { body: @testimonial.body, booking_id: @testimonial.booking_id, title: @testimonial.title }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
