...
class GuestsControllerTest < ActionController::TestCase
  ...
  test "should create guest" do
    assert_difference('Guest.count') do
      post :create, guest: { email: @guest.email, password: @guest.password, username: @guest.username }
    end
  ...
  test "should update guest" do
    patch :update, id: @guest, guest: { email: @guest.email, password: @guest.password, username: @guest.username }
    assert_redirected_to guest_path(assigns(:guest))
  end
