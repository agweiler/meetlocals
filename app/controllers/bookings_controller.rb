class BookingsController < ApplicationController
  ...
  private
    ...
    def booking_params
      params.require(:booking).permit(:start_time, :end_time, :date, :date_text, :guest_id, :experience_id, :status, :group_size, :is_private, :rating, :add_info, :no_of_adults, :no_of_children)
    end
end
