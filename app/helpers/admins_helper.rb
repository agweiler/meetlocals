module AdminsHelper
	...
	def convert_to_csv(bookings)
		attributes = %w{event_date booking_ID guest_name guest_id host_name host_id host_address host_zip_and_town host_email host_phone host_account_number price_paid host_paid?}
		row = []
